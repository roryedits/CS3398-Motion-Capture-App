...
final class BluetoothSerial: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    func disconnect() {
        for peripheral in connectedPeripherals{
            print("Connected peripherals before: " + String(centralManager.retrieveConnectedPeripherals(withServices: [serviceUUID]).count))
            centralManager.cancelPeripheralConnection(peripheral)
            print("Connected peripherals after: " + String(centralManager.retrieveConnectedPeripherals(withServices: [serviceUUID]).count))
        }
